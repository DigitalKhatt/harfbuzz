...
struct JtstSteps : List16OfOffset16To<JtstStep>
{
  bool sanitize (hb_sanitize_context_t *c,
		 const Record_sanitize_closure_t * = nullptr) const
  {
    TRACE_SANITIZE (this);
    return_trace (List16OfOffset16To<JtstStep>::sanitize (c));
  }
};
...
struct JTST
{
  ...
  Offset16To<JtstSteps> stretchSteps;
  Offset16To<JtstSteps> shrinkSteps;
  Offset16To<JtstAfterGsub> afterGsubLookups;
